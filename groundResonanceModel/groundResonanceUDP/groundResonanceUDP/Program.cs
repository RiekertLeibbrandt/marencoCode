...
<<<<<<< HEAD
        ...
        public static IPEndPoint receiveEndPoint = new IPEndPoint(IPAddress.Parse("192.168.60.240"), 49002);   // This is the netduino's ip.
=======
        public static IPEndPoint sendingEndPoint = new IPEndPoint(IPAddress.Parse("192.168.60.241"), 49001);    // This is james' desktop
        public static IPEndPoint receiveEndPoint = new IPEndPoint(IPAddress.Parse("192.168.60.250"), 49002);   // This is the netduino's ip.
>>>>>>> origin/master
